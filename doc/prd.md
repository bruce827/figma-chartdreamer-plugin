...
| **图表配置** | - 支持图表尺寸、节点宽度、边距等基础布局配置。<br>- 支持预设主题（浅色/深色）和完全自定义的颜色配置。<br>- 支持多种样式配置：节点形状、链接样式、阴影、渐变等。<br>- **智能尺寸适配**：当用户在Figma中选中一个frame时，插件自动检测该frame的尺寸，并据此调整桑基图的绘制尺寸，实现完美适配。 | P0   | 🔄 开发中 |
